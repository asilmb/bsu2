...
<noscript>
	<div><img src="https://mc.yandex.ru/watch/46788966" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
...
<div class="wrapper">
	<div class="content">
		...
		<div class="nav--sections">
			<div class="container">
				<a href="#" class="section-item" onclick="showDontWork();"><img src="/images/receiving.png"/>
				...
				<a href="#" class="section-item" onclick="showDontWork();"><img src="/images/forum.png"/>
...
<div class='dontworkOverLay' id="dontworkOverLay" onclick="closeDontWork();">
<div class='dontworkPopup'>
	<p>Извините сервис временно не доступен!</p>
	<a class="btn" id="closePupup" onclick="closeDontWork();"> Ok</a>
</div>
</div>
<?php Page::endDraw() ?>
