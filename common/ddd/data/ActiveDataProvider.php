 ...
 * ```
 *
 * For more details and usage information on ActiveDataProvider, see the [guide article on data
 * providers](guide:output-data-providers).
 *
...
class ActiveDataProvider extends BaseDataProvider {
	 ...
	 *
	 * - If [[query]] is an [[\yii\db\ActiveQuery]] instance, the primary keys of [[\yii\db\ActiveQuery::modelClass]]
	 *     will be used.
	...
	public function init() {
		...
		$this->params = $getParams->getAllParams($params);
	}
	...
	protected function prepareModels() {
		/*if (!$this->service instanceof QueryInterface) {
		...
		/*if (!empty($this->params['sort'])) {
			$query->addOrderBy($this->params['sort']);
		}*/
