...
use frontend\modules\bank\controllers\CardController;
...
?>
	<?= Html::endForm(); ?>
	<?= Html::hiddenInput('CardOperationId', $model->getOperationId(), array('id' => 'CardOperationId')); ?>
    <iframe src='javascript: return false;' name='replenishmentFrame' id='replenishmentFrame' class="replenishmentFrame"></iframe>
</div>
